...
void        ku_gen_textstyle_force_font(char* path);
...
textstyle_t ku_gen_textstyle_parse(ku_view_t* view)
{
    ...
    if (view->style.margin_left < INT_MAX)
	style.margin_left = view->style.margin_left;
    if (view->style.margin_right < INT_MAX)
	style.margin_right = view->style.margin_right;
    if (view->style.margin_top < INT_MAX)
	style.margin_top = view->style.margin_top;
    if (view->style.margin_bottom < INT_MAX)
	style.margin_bottom = view->style.margin_bottom;
